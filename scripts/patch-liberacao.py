...
if old not in s:
    raise SystemExit('Trecho de verificacao de liberacao nao encontrado')
...
if old not in s:
    raise SystemExit('Trecho alterarPendente nao encontrado')
s = s.replace(old, new, 1)
...
if old not in s:
    raise SystemExit('Trecho de status pendente nao encontrado')
s = s.replace(old, new, 1)
